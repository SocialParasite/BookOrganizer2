...
{
	public partial class GetPeriodicalReadReport : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.Sql(@"
				CREATE PROC GetPeriodicalReadReport
					@start_year INT = NULL,
					@end_year	INT = NULL
				AS
				SET NOCOUNT ON;
		...
		{
			migrationBuilder.Sql("DROP PROC IF EXISTS GetPeriodicalReadReport");
		}
	}
}
